...
{
       0,    89,    89,    90,    93,   100,   109,   110,   111,   112,
     113,   114,   115,   116,   117,   118,   119,   122,   123,   124,
     125,   126,   127,   128,   129,   130,   131,   132,   132,   133,
     133,   134,   134,   135,   135,   136,   139,   142,   143,   144,
     145,   146,   147,   149,   157,   173,   191,   192,   193,   194,
     195,   198,   199,   200,   201,   204,   205,   207,   216,   226,
     227,   229,   247,   254,   262,   263,   266,   267,   270,   271,
     273,   274,   277,   285,   298,   312,   313,   316,   327,   328,
     328,   331,   332,   335,   350,   356,   364,   372,   372,   372,
     388,   389,   390,   391,   392,   395,   396,   399,   408,   411,
     413,   428,   431,   440,   449,   450,   451,   451,   453,   463,
     475,   485,   497,   497,   499,   508
};
#endif
...
#line 89 "Alpha_Compiler/parser.y"
                                {}
#line 1949 "parser.c"
    break;

  case 3: /* program: stmts  */
#line 90 "Alpha_Compiler/parser.y"
                                        {free((yyvsp[0].stmtVal));}
#line 1955 "parser.c"
    break;

  case 4: /* stmts: stmt  */
#line 94 "Alpha_Compiler/parser.y"
                        {
...
#line 101 "Alpha_Compiler/parser.y"
                        {
...
#line 2031 "parser.c"
  ...
  case 15: /* stmt: ';'  */
#line 118 "Alpha_Compiler/parser.y"
                                        {resetTemp(); (yyval.stmtVal) = make_stmt();}
#line 2037 "parser.c"
    break;

  case 16: /* stmt: error  */
#line 119 "Alpha_Compiler/parser.y"
...
#line 2139 "parser.c"
  ...
  case 33: /* $@4: %empty  */
#line 135 "Alpha_Compiler/parser.y"
                    {emit_ifnotboolexpr((yyvsp[-1].exprNode));}
#line 2145 "parser.c"
    break;
...
#line 2151 "parser.c"
  ...
  case 35: /* expr: term  */
#line 136 "Alpha_Compiler/parser.y"
                 {(yyval.exprNode) = (yyvsp[0].exprNode);}
#line 2157 "parser.c"
    break;

  case 36: /* W: %empty  */
#line 139 "Alpha_Compiler/parser.y"
...
#line 158 "Alpha_Compiler/parser.y"
                        {
...
#line 174 "Alpha_Compiler/parser.y"
                                {
...
#line 200 "Alpha_Compiler/parser.y"
...
#line 201 "Alpha_Compiler/parser.y"
...
#line 217 "Alpha_Compiler/parser.y"
                        {
				do_backpatching((yyvsp[-1].exprNode));
				(yyvsp[-3].exprNode) = emit_iftableitem((yyvsp[-3].exprNode));
				(yyval.exprNode) = newexpr(tableitem_e);
...
#line 248 "Alpha_Compiler/parser.y"
                        {
...
#line 255 "Alpha_Compiler/parser.y"
                        {
				expr* func = newexpr(programfunc_e);
...
#line 286 "Alpha_Compiler/parser.y"
                                {
					expr* t = newexpr(newtable_e);
					t->sym = newTemp();
					emit(tablecreate, t, NULL, NULL, 0, 0);
...
#line 299 "Alpha_Compiler/parser.y"
                                {
					expr* t = newexpr(newtable_e);
					t->sym = newTemp();
					emit(tablecreate, t, NULL, NULL, 0, 0);
...
#line 2507 "parser.c"
  ...
  case 78: /* block: '{' '}'  */
#line 327 "Alpha_Compiler/parser.y"
                                                        {hide(current_scope+1); (yyval.stmtVal)=make_stmt();}
#line 2513 "parser.c"
    break;

  case 79: /* $@5: %empty  */
#line 328 "Alpha_Compiler/parser.y"
                {SCOPEUP;}
#line 2519 "parser.c"
    break;
...
#line 331 "Alpha_Compiler/parser.y"
                                {(yyval.strVal) = (yyvsp[0].strVal);}
#line 2531 "parser.c"
    break;

  case 82: /* funcname: %empty  */
#line 332 "Alpha_Compiler/parser.y"
                                {(yyval.strVal) = newTempFuncName();}
#line 2537 "parser.c"
    break;

  case 83: /* funcprefix: "function" funcname  */
#line 336 "Alpha_Compiler/parser.y"
                                {
					emit(jump, NULL, NULL, NULL, 0, yylineno);
...
#line 2554 "parser.c"
  ...
  case 84: /* funcargs: '(' ')'  */
#line 351 "Alpha_Compiler/parser.y"
                        {
				enterScopeSpace();
...
#line 357 "Alpha_Compiler/parser.y"
                        {	
				enterScopeSpace();
				resetFunctionLocalsOffset();
				pushCurrLoopCounter(loopcounter);
...
#line 365 "Alpha_Compiler/parser.y"
                        {
...
#line 2584 "parser.c"
  ...
  case 87: /* $@6: %empty  */
#line 372 "Alpha_Compiler/parser.y"
...
#line 373 "Alpha_Compiler/parser.y"
                        {
				exitScopeSpace();
...
#line 414 "Alpha_Compiler/parser.y"
                        {
...
#line 428 "Alpha_Compiler/parser.y"
                                {(yyval.numVal) = nextQuadLabel();}
#line 2702 "parser.c"
    break;

  case 102: /* whilecond: '(' expr ')'  */
#line 432 "Alpha_Compiler/parser.y"
                                {
					do_backpatching((yyvsp[-1].exprNode));
					emit(if_eq, NULL, (yyvsp[-1].exprNode), newexpr_constbool(1), nextQuadLabel()+2, yylineno);
					(yyval.numVal) = nextQuadLabel();
...
#line 441 "Alpha_Compiler/parser.y"
                                {
...
#line 2724 "parser.c"
  ...
  case 104: /* N: %empty  */
#line 449 "Alpha_Compiler/parser.y"
    {(yyval.numVal) = nextQuadLabel(); emit(jump, NULL, NULL, NULL, 0, yylineno);}
#line 2730 "parser.c"
    break;

  case 105: /* M: %empty  */
#line 450 "Alpha_Compiler/parser.y"
    {(yyval.numVal) = nextQuadLabel();}
#line 2736 "parser.c"
    break;

  case 108: /* forprefix: "for" '(' E ';' M expr ';'  */
#line 454 "Alpha_Compiler/parser.y"
                                {
					do_backpatching((yyvsp[-1].exprNode));
...
#line 464 "Alpha_Compiler/parser.y"
                                {
...
#line 476 "Alpha_Compiler/parser.y"
                                {
					if(!func_scope)
...
#line 486 "Alpha_Compiler/parser.y"
                                {
					do_backpatching((yyvsp[-1].exprNode));
					if(!func_scope)
						yyerror("return statement not within function");
...
#line 2791 "parser.c"
  ...
  case 112: /* $@8: %empty  */
#line 497 "Alpha_Compiler/parser.y"
           {++loopcounter;}
#line 2797 "parser.c"
    break;
...
#line 500 "Alpha_Compiler/parser.y"
                        {
				if(!loopcounter)
...
#line 509 "Alpha_Compiler/parser.y"
                        {
				if(!loopcounter)
...
#line 517 "Alpha_Compiler/parser.y"

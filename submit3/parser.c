...
{
       0,   109,   109,   110,   113,   120,   129,   130,   131,   132,
     133,   134,   135,   136,   137,   138,   139,   142,   143,   144,
     145,   146,   147,   148,   149,   150,   151,   152,   152,   153,
     153,   154,   154,   155,   155,   156,   159,   162,   163,   164,
     165,   166,   167,   169,   177,   193,   210,   211,   212,   213,
     214,   217,   218,   219,   220,   223,   224,   226,   235,   245,
     246,   248,   266,   273,   281,   282,   285,   286,   289,   290,
     292,   293,   296,   304,   317,   331,   332,   335,   346,   347,
     347,   350,   351,   354,   369,   375,   383,   391,   391,   391,
     407,   408,   409,   410,   411,   414,   415,   418,   427,   430,
     432,   447,   450,   459,   468,   469,   470,   470,   472,   482,
     494,   504,   516,   516,   518,   527
};
#endif
...
#line 2008 "parser.c"
  ...
  case 6: /* stmt: expr ';'  */
#line 129 "parser.y"
                                {do_backpatching((yyvsp[-1].exprNode)); resetTemp(); (yyval.stmtVal) = make_stmt();}
#line 2014 "parser.c"
    break;

  case 7: /* stmt: ifstmt  */
#line 130 "parser.y"
                                        {resetTemp(); (yyval.stmtVal) = (yyvsp[0].stmtVal);}
#line 2020 "parser.c"
    break;
...
#line 194 "parser.y"
                                {
					funcAsLvalue((yyvsp[-2].exprNode));
					do_backpatching((yyvsp[0].exprNode));
					if((yyvsp[-2].exprNode)->type == tableitem_e) {
						emit(tablesetelem, (yyvsp[0].exprNode), (yyvsp[-2].exprNode), (yyvsp[-2].exprNode)->index, 0, yylineno);
